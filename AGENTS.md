...
YuWanCard 是一个基于 BaseLib 框架开发的 Slay the Spire 2 模组，实现了 23 张无色卡牌、5 个能力效果、12 个遗物、1 个先古之民、1 个怪物和 1 个无尽模式 modifier。

**内容概览**：
- 23 张无色卡牌（包含猪主题卡牌、雨落狂流之暗等）
- 5 个能力（猪疑惑、雨落狂流、猪破产、猪脑过载、你是猪）
