...
public sealed class PiggyBankRune : HextechPigRuneBase
{
    ...
    public override async Task AfterGoldGained(Player player)
    {
        ...
        Flash();
        await PowerCmd.Apply<PigChargePower>(Owner!.Creature, DynamicVars["PigChargePower"].BaseValue, Owner.Creature, null);
    }
}
