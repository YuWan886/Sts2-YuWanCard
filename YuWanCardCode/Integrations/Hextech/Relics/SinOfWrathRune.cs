...
public sealed class SinOfWrathRune : HextechSharedRuneBase
{
    ...
    public override async Task AfterDamageReceived(PlayerChoiceContext choiceContext, Creature target, DamageResult result, ValueProp props, Creature? dealer, CardModel? cardSource)
    {
        ...
        Flash();
        await PowerCmd.Apply<StrengthPower>(new ThrowingPlayerChoiceContext(), Owner.Creature, DynamicVars.Strength.BaseValue, Owner.Creature, cardSource);
        await PowerCmd.Apply<AbsorptionPower>(new ThrowingPlayerChoiceContext(), Owner.Creature, DynamicVars["GuardAmount"].BaseValue, Owner.Creature, cardSource);
    }
}
