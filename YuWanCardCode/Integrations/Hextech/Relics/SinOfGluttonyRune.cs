...
public sealed class SinOfGluttonyRune : HextechSharedRuneBase
{
    ...
    public override async Task AfterCardExhausted(PlayerChoiceContext choiceContext, CardModel card, bool causedByEthereal)
    {
        ...
        Flash();
        await PowerCmd.Apply<StrengthPower>(Owner!.Creature, DynamicVars.Strength.BaseValue, Owner.Creature, card);
    }
    ...
    public override async Task AfterCardPlayed(PlayerChoiceContext context, CardPlay cardPlay)
    {
        ...
        Flash();
        await PowerCmd.Apply<DexterityPower>(Owner!.Creature, DynamicVars.Dexterity.BaseValue, Owner.Creature, cardPlay.Card);
    }
}
