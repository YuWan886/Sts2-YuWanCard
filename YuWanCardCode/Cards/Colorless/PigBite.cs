...
public class PigBite : YuWanCardModel
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<PoisonPower>(new ThrowingPlayerChoiceContext(), targetCreature, DynamicVars["PoisonPower"].BaseValue, Owner.Creature, this);
        await PowerCmd.Apply<WeakPower>(new ThrowingPlayerChoiceContext(), targetCreature, DynamicVars["WeakPower"].BaseValue, Owner.Creature, this);
        await PowerCmd.Apply<VulnerablePower>(new ThrowingPlayerChoiceContext(), targetCreature, DynamicVars["VulnerablePower"].BaseValue, Owner.Creature, this);
