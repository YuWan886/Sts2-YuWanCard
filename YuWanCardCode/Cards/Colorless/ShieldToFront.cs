...
public class ShieldToFront : YuWanCardModel
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        foreach (var creature in teammates)
        {
            ...
            {
                await PowerCmd.Apply<ShieldToFrontPower>(new ThrowingPlayerChoiceContext(), creature, 1, Owner.Creature, this);
            }
            else
            {
                await PowerCmd.Apply<ShieldToFrontImmunePower>(new ThrowingPlayerChoiceContext(), creature, 1, Owner.Creature, this);
            }
        }
    }
