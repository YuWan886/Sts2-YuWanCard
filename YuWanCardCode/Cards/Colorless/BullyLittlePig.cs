...
public class BullyLittlePig : YuWanCardModel
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<BullyLittlePigSkittishPower>(new ThrowingPlayerChoiceContext(), Owner.Creature, DynamicVars["BullyLittlePigSkittishPower"].BaseValue, Owner.Creature, this);
