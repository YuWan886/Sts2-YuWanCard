...
public class TragicMandarinDuckPower : YuWanPowerModel
{
    ...
    public override async Task AfterPlayerTurnStart(PlayerChoiceContext choiceContext, Player player)
    {
        ...
        Flash();
        await PowerCmd.Apply<StrengthPower>(choiceContext, Owner, DynamicVars["GainStrength"].IntValue, Owner, null);
        await PowerCmd.Apply<DexterityPower>(choiceContext, Owner, DynamicVars["GainDexterity"].IntValue, Owner, null);
    }
