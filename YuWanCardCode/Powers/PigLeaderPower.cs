...
public class PigLeaderPower : YuWanPowerModel
{
    ...
    public override async Task AfterPlayerTurnStart(PlayerChoiceContext choiceContext, Player player)
    {
        ...
        {
            Flash();
            await PowerCmd.Apply<PigFriendsPower>(new ThrowingPlayerChoiceContext(), Owner, 1, Owner, null);
        ...
        {
            Flash();
            await PowerCmd.Apply<PigLeaderBoostPower>(new ThrowingPlayerChoiceContext(), pig, Amount, Owner, null);
        }
    }
}
