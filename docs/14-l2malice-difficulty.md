...
| Gravity（重力） | 己方回合开始时令所有玩家失去 Strength |
...
| Shulker（潜影） | 每 2 回合对随机玩家造成不可格挡伤害 |
...
| Killer Aura（杀手光环） | 每 3 回合对所有玩家造成伤害 |
| Ragnarok（诸神黄昏） | 每 4 回合对所有玩家造成大量不可格挡伤害 |
...
将 L2Hostility 的 7 宗罪诅咒移植为恶意遗物，通过事件/宝箱获取：

| 遗物 | 稀有度 | 效果 |
|------|--------|------|
| 嫉妒遗物（Envy） | Uncommon | 词条敌人 25% 概率额外掉落一张卡牌 |
| 贪婪遗物（Greed） | Rare | 词条敌人掉落金币翻倍 |
| 暴怒遗物（Wrath） | Uncommon | 对词条敌人的伤害 +25% |
| 傲慢遗物（Pride） | Boss | 击杀词条敌人获得 +1 Strength（本场战斗）；词条出现概率 +50% |
| 懒惰遗物（Sloth） | Rare | 词条敌人不再掉落额外奖励；所有敌人不再获得词条（关闭恶意系统） |
| 暴食遗物（Gluttony） | Uncommon | 击杀词条敌人回复 5 HP |
| 色欲遗物（Lust） | Rare | 词条敌人 15% 概率额外掉落一件遗物 |
